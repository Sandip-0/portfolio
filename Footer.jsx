            ...
            <nav className='SOCIALS'>
                <ul style={{
                    ...
                    <li style={{ margin: '0 10px' }}>
                        <a target="_blank" rel="noopener noreferrer" href="https://github.com/Sandip-0" className="link-light link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">
                            GitHub
                        </a>
                    </li>
                    <li style={{ margin: '0 10px' }}>
                    ...
                    <li style={{ margin: '0 10px' }}>
                        <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/sandip.adak.1401?mibextid=kFxxJD" className="link-light link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">
                            Facebook
                        </a>
                    </li>
                    <li style={{ margin: '0 10px' }}>
                        <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/sandip_adak_?utm_source=qr&igsh=N2NjcjA0OXBzdDBv" className="link-light link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">
                            Instagram
                        </a>
                    </li>
                </ul>
