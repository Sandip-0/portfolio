...
function Contact() {
  return (
    <div className="contact">
      ...
      <div className="d-flex justify-content-center flex-wrap">
        <div>
          ...
          <div className="form-box">
            ...
            <input type="text" name="" className="field" defaultValue="" required placeholder="Web design & Web Development...  *" id="form-service"
            />
          </div>
          <div className="form-box">
            <h1>Your message</h1>
      ...
      <div class="socials d-flex justify-content-center pb-5">
