  ...
  return (
    <div className="contact">
      ...
      <div className="socials d-flex justify-content-center pb-5">
        <li><a target="_blank" rel="noopener noreferrer" href="https://wa.me/9134460122" ><FontAwesomeIcon icon={faWhatsapp} size="4x" color="white" /></a></li>
        <li><a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/sandip-adak-70586a2b3?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" > <FontAwesomeIcon icon={faLinkedin} size="4x" color="white" /></a></li>
        <li><a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/sandip.adak.1401?mibextid=kFxxJD" > <FontAwesomeIcon icon={faFacebook} size="4x" color="white" /></a></li>
        <li><a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/sandip_adak_?utm_source=qr&igsh=N2NjcjA0OXBzdDBv" > <FontAwesomeIcon icon={faInstagram} size="4x" color="white" /></a></li>
      </div>
    </div>
  );
}
